    ...
    <div className="min-h-screen bg-[#F4F6FA] px-6 py-10">
              ...
              <div className="p-8 pl-16">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
                  <div className="md:col-span-6">
                    ...
                    <input
                      value={it.merek}
                      onChange={(e) => updateItem(it.id, "merek", e.target.value)}
                      className="mt-2 h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm outline-none focus:ring-2 focus:ring-blue-200"
                    />
                  </div>
                ...
                <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-12">
                  <div className="md:col-span-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateItem(it.id, "paguPerItem", Number(e.target.value))
                      }
                      className="mt-2 h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm outline-none focus:ring-2 focus:ring-blue-200"
                    />
                  </div>
                  ...
                  <div className="md:col-span-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateItem(it.id, "hargaTayang", Number(e.target.value))
                      }
                      className="mt-2 h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm outline-none focus:ring-2 focus:ring-blue-200"
                    />
                  </div>
      ...
      {openRevisi && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-180 max-w-[92vw] rounded-2xl bg-[#dedede] p-7 shadow-xl">
            ...
            <div className="mt-4 flex overflow-hidden rounded-xl bg-gray-300/70">
              ...
              <button
                ...
                className="h-12 bg-white px-6 text-sm font-semibold hover:bg-gray-50"
              >
                LOAD ID
              </button>
            </div>
